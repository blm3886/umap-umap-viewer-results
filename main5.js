...
document.getElementById("umap").appendChild(renderer.domElement);
...
function ensureLabel(i, text) {
  ...
  if (!el) {
    ...
    document.getElementById("umap").appendChild(el);
  }
  el.textContent = text;
}
...
//   `;
  ...
  document.getElementById("umap").appendChild(ui);
...
document.getElementById("umap").appendChild(aiPanel);
...
// === floating gene list container (below the panel) ===
    ...
    document.getElementById("umap").appendChild(geneStack);
